# 历史 README（2026-09-15 整理前快照）

> 仅用于追溯，不是当前操作指南。原文包含已过时的 stdio 接入、TLS 替代说法、全局终止 Node 进程等不应照做的建议。当前入口见 [README](../../README.md)，已知限制见 [开发与验证](../development.md)。外部 Bridge/Add-on 行为未在本次重新验证。
